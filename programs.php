<div class="program-links text-center">
    ...
    <a href="<?php echo home_url('/devosional'); ?>" rel="noopener noreferrer" class="program-image-link">
    ...
    <a href="<?php echo home_url('/podcast'); ?>" rel="noopener noreferrer" class="program-image-link">
        <span class="program-image-wrap">
    ...
    <a href="<?php echo home_url('/saude'); ?>" rel="noopener noreferrer" class="program-image-link">
        <span class="program-image-wrap">
    ...
    <a href="<?php echo home_url('/filme'); ?>" rel="noopener noreferrer" class="program-image-link">
        <span class="program-image-wrap">
...
<div class="p-3 text-center">
    <a href="<?php echo home_url('/programa'); ?>" class="btn btn-primary">Esplora Programa sira</a>
</div>